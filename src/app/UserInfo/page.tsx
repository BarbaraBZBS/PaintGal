  ...
  return (
    <>
      {session?.user?.role !== "admin" ? (
        <div className="grid h-[60vh] place-content-center grid-rows-[55%_20%] gap-[3rem] mb-[2rem]">
          <div className="grid place-content-center gap-[2rem]">
            <h1 className="text-[3rem] mb-[1.5rem]">
          ...
          <div className="grid h-[60vh] place-self-center place-content-center gap-[2rem]">
            <h1 className="text-[3rem] mb-[1.5rem]">
              {session?.user?.firstName}
            </h1>
            <p className="text-[1.5rem]">{session?.user?.lastName}</p>
